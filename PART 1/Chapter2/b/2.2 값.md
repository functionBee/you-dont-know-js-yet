...
마지막 원시 값은 심볼인데, 심볼은 객체엇 특정한 키를 만들 때 주로 사용합니다.

심볼은 객체에서 특정한 키를 만들 때 주로 사용합니다.
...
일반적인 JS 프로그램에서는 심볼의 직접적인 사용을 자주 접하지 않습니다.

심볼은 주로 라이브러리와 프레임워크와 같은 저수준 코드에서 사용됩니다.
